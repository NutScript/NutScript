...
LANGUAGE = {
	...
	vendorNoTrade = "No puede comprar a este vendedor.",
	vendorNoMoney = "Este vendedor no puede pagar ese artículo.",
	vendorNoStock = "Este vendedor no tiene ese artículo en stock.",
	contentTitle = "Content del NutScript Ausent",
	contentWarning = "No tienes el contenido de NutScript montado. Esto puede resultar en la falta de ciertas funciones.\nUtilice el contenido de Nutscript de Rebel1324.\n¿Le gustaría abrir la página del Workshop para el contenido de NutScript?",
	flags = "Flags",
